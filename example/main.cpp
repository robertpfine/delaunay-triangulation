...
int main2D(int argc, char * argv[])
{
    ...
    for(int i = 0; i < numberPoints; ++i) {
        ...
        std::cout << "position x: " << points[i].x << " position y: " << points[i].y << std::endl;
    }
    ...
    for(int i = 0; i < triangles.size(); ++i) {
        ...
        std::cout << "triangle: " << i <<  " "
                  << "vertex 1:" <<  "position x: " << triangles[i].a->x << " position y: " << triangles[i].a->y
                  << "vertex 2:" <<  "position x: " << triangles[i].b->x << " position y: " << triangles[i].b->y
                  << "vertex 3:" <<  "position x: " << triangles[i].c->x << " position y: " << triangles[i].c->y
                  << std::endl;
    }
